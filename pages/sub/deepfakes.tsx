          ...
          <StyledText
            text={
              <p>
                ...
                der Belgien rät aus dem Pariser Klimaabkommen auszutreten [1] –
          ...
          <StyledText
            text={
              <p>
                ...
                Menschen ist hierbei nötig. [2] <br />
                ...
                ohne dass ein Einschreiten in den Lernprozess von Nöten ist [2]
              </p>
            }
          />
          <img src={'/zwiebel.png'} />
          ...
          <StyledText
            text={
              <p>
                ...
                beliebig viele Ebenen [4]. In diesen{' '}
                <span className={'text-sky-400'}>verborgenen Schichten</span>{' '}
                ...
                Schichten an [4]. Hier findet eine Berechnung des
                Gesamtergebnisses statt [4]. In unserem Fall werden alle
          ...
          <StyledText
            text={
              <p>
                ...
                Gesichtes angeschlossen wird. [7]
              </p>
            }
          />
