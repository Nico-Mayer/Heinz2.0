                ...
                <div
                    ...
                    <StyledText
                        text={"Ein Battle-Rap zwischen Donald Trump und Joe Biden, widersprüchliche Weihnachtsgrüße der Queen oder Donald Trump, " +
                            ...
                            "überhaupt treffen und ein mögliches Ende ihre Karriere riskieren? \nDie Antwort darauf lässt sich einfach sagen: gar nicht. " +
                            ...
                            "im Netz komplett verändert. \n\nEs stellt sich die Frage: wie funktionieren Deepfakes? \nAntwort: Neuronale Netze, bzw. Machine " +
                            "Learning (deutsch: maschinelles Lernen)."}/>
                    <SubHeader title={"Neuronale Netze"}/>
                    <StyledText
                        text={"Wie der Name Deepfake bereits zu verstehen gibt, handelt es sich bei dem Wort um " +
                    ...
                    <StyledText text={"Deep Learning gehört in der Informatik zum Bereich der Künstlichen " +
                        "Intelligenz und ist wiederum ein Teilbereich des sogenannten Machine Learnings (dt. Maschinelles Lernen). \nZiel des Machine Learnings, " +
                        ...
                        "ist hierbei nötig. [2] \nStatt Systeme anhand von vorhandenen Daten trainieren zu lassen, wird beim Deep Learning das menschliche Gehirn " +
                        ...
                        "würde: betrachten, analysieren und Schlussfolgerung ziehen [3]. \nGroße Datensätze werden schneller erfasst und analysiert als ein Mensch " +
                    ...
                    <StyledText
                        text={"Ein Computer soll nun mithilfe von einem künstlichen neuronalen Netz eine handgeschriebene Zahl erkennen. Zu Beginn werden " +
                            ...
                            "Notiz in einzelne Pixel aufgeteilt und diese in die Neuronen der Eingabeschicht geworfen. \nEin Neuron enthält somit ein Pixel. \n" +
                            ...
                            "trifft. \nGenerell gilt, je höher die Gewichtung, desto repräsentativer ist die zugehörige Verbindung für das Endergebnis. Weist eine " +
                            "Gewichtung den Wert Null auf, so hat das dazugehörige Neuron keinen Einfluss auf das Endergebnis. Diese gewichteten Daten " +
                            "werden nun von der Eingabeschicht in die verborgenen Schichten weitergegeben.\nDie verborgenen Schichten befinden sich zwischen der " +
                            ...
                            "statt. \nIn unserem Beispiel lassen sich hier die Kombination von mehreren Pixeln im Verhältnis zueinander identifizieren, Kanten " +
                            ...
                            "hervor. \nDiese Verbindung repräsentiert das Endergebnis und das IT-System weiß, dass die handgeschriebene Notiz zu Beginn die Zahl 6 ist. "}/>
                    <SubHeader title={"Topologien neuronaler Netze"}/>
                    <StyledText
                        text={"Neuronale Netze weisen unterschiedliche Strukturen, auch Topologie genannt, auf. Diese beschreibt, wie das künstliche neuronale " +
                            ...
                            "Netzen sind das einschichtige feedforward-Netz, das mehrschichtige feedforward-Netz und das rekurrente Netz. \nBei einschichtigen " +
                    ...
                    <StyledText
                        text={"Bei Deepfakes wird der Prozess des Deep Learnings besonders bei der Gesichtserkennung und der Angleichung von dem " +
                            ...
                            "also zwei bilderzeugenden neuronalen Netzwerken, welche sich gegenüberstehen.\nSo werden zunächst die zwei Ausgangsvideos, in ihre Einzelbilder " +
                            ...
                            "Gewichtungen modifiziert. \nDer Vorgang wird nun so lange wiederholt, bis die Ausgabe der Decoder dem Ursprungsbild stark ähnelt. Dies wird auch " +
                            "Überwachtes Lernen genannt."}/>
                    <img className={"p-4"} src={"/algorithmus.png"}/>
                    <StyledText
                        text={"Anschließend findet der eigentliche Gesichter Tausch statt, indem der Encoder des einen Gesichtes an den Decoder des anderen Gesichtes angeschlossen wird. [7]"}/>
                    ...
                    <StyledText
                        text={"Fest steht: all diese Berechnungen für Enkodierung und Dekodiereung brauchen viel Rechenleistung. Heißt also, es steckt sehr viel Mathematik " +
                    ...
                    <StyledText
                        text={"Neben dem Gesichtstausch gibt es natürlich noch weitere Anwendungsmöglichkeiten."}/>
