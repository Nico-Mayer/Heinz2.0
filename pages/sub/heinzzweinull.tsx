    ...
    return (
        ...
        <main className="m-auto flex h-full w-full max-w-7xl flex-col items-center justify-center px-20 text-center">
            ...
            <div className={"z-10 flex min-h-screen flex-1 flex-col items-center justify-center bg-heinzGrau ring-2 ring-heinzBlau/[.40] shadow-2xl"}>
                ...
                <StyledText
                    text={<p>Warum eigentlich ein Projekt zum Thema Deepfakes und woher kam der Anreiz? <br/>
                    ...
                    Neben Projekten wie VR oder AR Spielen, Browseranwendungen oder Handyapps zum Thema Nachhaltigkeit befasst
                        sich eine Projektgruppe, nämlich wir als Gruppe <span className={"text-heinzBlau"}>Heinz 2.0</span>, mit Deepfakes.<br/></p>}/>
                ...
                <StyledText
                    text={<p>Ziel unseres Projektes ist es ein möglichst realistisches Deepfake unseres ehemaligen Professors
                    Heinz Brünig zu erstellen. Da dieser nun im Jahre 2022 in Rente geht und das Lehren im Hochschullalltag
                    beiseitelegt, erstellen wir mit unserem Projekt <span className={"text-heinzBlau"}>Heinz 2.0</span> eine Möglichkeit Professor Brünig weiterhin im
                    Hochschulleben erhalten zu können. <br/>Grundlage unserer Arbeit sind hierbei Videos, einmal von Professor Brünig
                    ...
                    der Person A verwendet, um eine Fälschung von Professor Brünig darstellen zu können. Ein sogenannter Gesichter
                        Tausch findet statt und die Person kann somit in die Rolle von Heinz Brünig schlüpfen. <br/>
                        Aber wer genau ist denn nun Heinz Brünig?</p>}/>
                <SubHeader title={"HEINZ BRÜNIG"}></SubHeader>
                <StyledText
                    text={<p>Prof. Dr. Heinz Brünig ist Professor für Angewandte Informatik, Interaktive Systeme, <br/>
                    ...
                    durften ihn bereits in den Vorlesungen Multimedia und Interaktion erleben. Da Prof. Brünig eine bekannte Person des
                        Hochschullebens ist, ist der Effekt ihn als Star eines Deepfakes zu sehen, größer als der einer berühmten Persönlichkeit.</p>}/>
